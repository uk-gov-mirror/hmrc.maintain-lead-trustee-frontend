...
import pages.trustee.individual.{CountryOfNationalityInTheUkYesNoPage, NamePage}
...
class CountryOfNationalityInTheUkYesNoControllerSpec extends SpecBase {
  ...
  "CountryOfNationalityInTheUkYesNoController" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val answers = baseAnswers.set(CountryOfNationalityInTheUkYesNoPage, true).success.value
