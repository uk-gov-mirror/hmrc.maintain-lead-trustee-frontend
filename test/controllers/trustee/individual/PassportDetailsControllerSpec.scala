...
class PassportDetailsControllerSpec extends SpecBase with MockitoSugar {
  ...
  private def form = formProvider.withPrefix("trustee.individual.passportDetails")
  ...
  val passportDetailsRoute: String = routes.PassportDetailsController.onPageLoad(index).url
  ...
  "PassportDetails Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers
        ...
        .set(PassportDetailsPage(index), validData).success.value
