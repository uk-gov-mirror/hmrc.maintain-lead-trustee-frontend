...
import pages.trustee.individual.{CountryOfNationalityYesNoPage, NamePage}
...
class CountryOfNationalityYesNoControllerSpec extends SpecBase {
  ...
  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("trustee.individual.countryOfNationalityYesNo")
  ...
  "CountryOfNationalityYesNoController" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val answers = baseAnswers.set(CountryOfNationalityYesNoPage, true).success.value
