...
import pages.trustee.individual.{CountryOfNationalityPage, NamePage}
...
import views.html.trustee.individual.CountryOfNationalityView

class CountryOfNationalityControllerSpec extends SpecBase {

  private val form: Form[String] = new CountryFormProvider().withPrefix("trustee.individual.countryOfNationality")
  ...
  "CountryOfNationalityController" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val answers = baseAnswers.set(CountryOfNationalityPage, validAnswer).success.value
