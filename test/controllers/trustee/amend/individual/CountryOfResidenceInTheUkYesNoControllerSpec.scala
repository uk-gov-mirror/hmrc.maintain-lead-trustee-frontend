...
import views.html.trustee.amend.individual.CountryOfResidenceInTheUkYesNoView
...
class CountryOfResidenceInTheUkYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  val form: Form[Boolean] = formProvider.withPrefix("trustee.individual.countryOfResidenceInTheUkYesNo")
  ...
  lazy val countryOfResidenceInTheUkYesNo: String = routes.CountryOfResidenceInTheUkYesNoController.onPageLoad().url
