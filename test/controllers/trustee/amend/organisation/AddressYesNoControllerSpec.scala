...
import pages.trustee.amend.organisation.{AddressYesNoPage, NamePage}
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.trustee.amend.organisation.AddressYesNoView
...
class AddressYesNoControllerSpec extends SpecBase {
  ...
  val onwardRoute = routes.AddressYesNoController.onPageLoad().url
