...
import pages.trustee.amend.organisation.{AddressInTheUkYesNoPage, NamePage}
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.trustee.amend.organisation.AddressInTheUkYesNoView
...
class AddressInTheUkYesNoControllerSpec extends SpecBase {
  ...
  "AddressInTheUkTheYesNo Controller" must {
