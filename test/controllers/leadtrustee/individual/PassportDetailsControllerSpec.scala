...
class PassportDetailsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val passportDetailsRoute = routes.PassportDetailsController.onPageLoad(NormalMode).url
  ...
  "PassportDetails Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(PassportDetailsPage, "answer").success.value
