...
echo "GET        /emailAddress                        controllers.leadtrustee.individual.EmailAddressController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /emailAddress                        controllers.leadtrustee.individual.EmailAddressController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeEmailAddress                  controllers.leadtrustee.individual.EmailAddressController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeEmailAddress                  controllers.leadtrustee.individual.EmailAddressController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
...
echo "emailAddress.error.length = EmailAddress must be 512 characters or less" >> ../conf/messages.en
