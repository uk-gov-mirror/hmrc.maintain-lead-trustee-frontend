...
echo "GET        /telephoneNumber                        controllers.leadtrustee.individual.TelephoneNumberController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /telephoneNumber                        controllers.leadtrustee.individual.TelephoneNumberController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeTelephoneNumber                  controllers.leadtrustee.individual.TelephoneNumberController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeTelephoneNumber                  controllers.leadtrustee.individual.TelephoneNumberController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
...
awk '/class/ {\
     ...
     print "    x =>";\
     print "      AnswerRow(";\
     print "        HtmlFormat.escape(messages(\"telephoneNumber.checkYourAnswersLabel\")),";\
